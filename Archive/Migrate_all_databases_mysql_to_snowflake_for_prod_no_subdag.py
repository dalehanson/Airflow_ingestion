...
parent_dag_name = 'Migrage_all_databases_mysql_to_snowflake_for_prod_no_subdag'
...
one_dag =  DAG(parent_dag_name, default_args=default_args, schedule_interval='@once', concurrency = 20) #in production, need to update this to run once daily (add various dags and set variables in Airflow?)
...
database_list = ['transaction_041501', 'transaction_111115', 'transaction_111116', 'transaction_11112', 'transaction_11113', 'transaction_11114', 'transaction_11115', 'transaction_11116', 'transaction_11129', 'transaction_11130', 'transaction_11131', 'transaction_11132', 'transaction_11133', 'transaction_11138', 'transaction_11141', 'transaction_11142', 'transaction_11143', 'transaction_11144', 'transaction_11145', 'transaction_267801', 'transaction_267802', 'transaction_267803', 'transaction_267804', 'transaction_267805', 'transaction_59002', 'transaction_59003', 'transaction_60rt01', 'transaction_ETAINC']   
...
for i in database_list:
    tbl_list = get_table_list(i, exclude_tables = True, exclude_tbls_list = excluded_tables) #collecting all table names from database database
    for t in tbl_list:
        dt_s3 = create_dynamic_task_tos3(i,t)
        dt_sf = create_dynamic_task_tosf(i,t)
        dt_s3 >> dt_sf
