...
def create_dynamic_task_collect_table_counts(database_name, table):
...
for i in database_list:
    tbl_list = get_table_list(i) #collecting all table names from database
    for t in tbl_list:
        dt_create_tables = create_dynamic_task_collect_table_counts(i, t)
